...
/*Sn_CR (Socket n Command Register) [R/W] [0x0401, 0x0501, 0x0601, 0x0701] [0x00]
  This register is utilized for socket n initialization, close, connection establishment,
  termination, data transmission and command receipt. After performing the commands,
  the register value will be automatically cleared to 0x00.*/
...
/*Sn_SR (Socket n Status Register) [R] [0x0403, 0x0503, 0x0603, 0x0703] [0x00]
  ...
  The main status is shown in the below diagram*/
